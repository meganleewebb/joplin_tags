...
# see https://github.com/pickerin/joplin-update-frontmatter
# The script had bugs and didn't do what I wanted.
#
...
TOKEN = "72db2c2f2ab76e8e5c13468cdfc31dc337c5aa42f8a9384f13e0ee3fccbeee6a96984df6f0aa391a95bcc74d9e9e087cd3402403dd6dd91ddfa1a89cff48f770"
...
def get_note_metadata(noteid):
    ...
    return requests.get(
        '{}/{}/?fields=body,title,user_created_time,user_updated_time&token={}'.format(NOTES_ENDPOINT, noteid, TOKEN))
...
for note in note_ids:
    ...
    if tag_names:
        ...
        if DEBUG:
            ...
            body = note_metadata.json()["body"]
            new_body = body + frontMatter
            if body is not None:
